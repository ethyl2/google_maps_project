...
function initMap() {
  ...
  var locations = [
    ...
    {title: 'Fryer Park', location: {lat: 40.349122, lng: -111.715525},
      url: 'https://jacobbarlow.com/2015/01/02/fryer-park/'},
    ...
    {title: 'Lindon Murdoch Canal Trailhead', location: {lat: 40.343716, lng: -111.696934},
      url: 'http://www.traillink.com/trail/murdock-canal-trail.aspx'}
  ];
...
function zoomToArea() {
  ...
  if (address == '') {
    ...
    geocoder.geocode(
      { address: address,
        componentRestrictions: {locality: 'Utah County'}
